...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LCTL,        KC_LGUI,      KC_APP ,KC_ESC,LT(SYMB, KC_ESC),
                                              KC_RBRC,       MO(META),
                                                              KC_ESC,
                                 RCTL_T(KC_SPC),SFT_T(KC_TAB),KC_MHEN,
        // right hand
             TG(GAME),    KC_7,   KC_8,   KC_9,   KC_0,   KC_MINS,          KC_EQL,
             S(KC_BSLS),  KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_LBRC,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          KC_QUOT,
             S(KC_9),     KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,          SFT_T(KC_RO),
                                  KC_DELT,KC_DELT,KC_UP,  KC_RGHT,          KC_JYEN,
             MO(META),            KC_BSLS,
             KC_DELT,
...
[SYMB] = KEYMAP(  // layer 1 : Symbol
        ...
        KC_TRNS,        KC_NO,        S(KC_EQL),S(KC_SLSH),S(KC_1),KC_NO,
        KC_TRNS,        KC_NO,        KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_TRNS,
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | LShift |  F2  |  F3  |  F4  |  F5  |  F6  |      |           |      |  F7  |  F8  |  F9  | F10  | F11  |  \ / S |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
...
[META] = KEYMAP(
       ...
       KC_1,      KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_TRNS,
       KC_TRNS,   KC_F1,   KC_NO,   KC_MHEN, KC_HENK, KC_NO,
